        ...
        <div class="container">
            <div class="row justify-content-lg-between">
                <div class="pt-5 col-12 col-lg-6 text-center text-lg-start">
                    ...
                    <p class="home-text">Общественные мероприятя, направленные на помощь молодёжи в профессиональном самоопределении с учетом их особенностей личности и социально-экономичекой ситуации на рынке труда</p>
                    <div class="home-text-d">
                        <a class="home-next" href="/teenager">Далее</a>
                    </div>
                ...
                <div class="col-lg-6 d-none d-lg-block d-flex justify-content-end">
                    <div class="pointer-none position-relative d-flex justify-content-end">
                        <img class="title__wave" src="assets/img/wave/wave.svg" alt="">
